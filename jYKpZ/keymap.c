...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LAYER5] = LAYOUT_planck_grid(
    ...
    MT(MOD_LCTL, KC_LBRC),TD(DANCE_0),    TD(DANCE_1),    MT(MOD_LSFT, KC_RBRC),KC_PIPE,        KC_TRANSPARENT, KC_TRANSPARENT, KC_0,           MT(MOD_RSFT, KC_1),MT(MOD_RGUI, KC_2),MT(MOD_LALT, KC_3),MT(MOD_RCTL, KC_4),
